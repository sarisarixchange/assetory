...
.meetTheTeamHeaderHomepage {
  width: 100%;
  background-color: var(--background-color-card-heading-one);
  text-align: center;
  font-family: var(--font-family-Decorative);
  color: var(--color-card-heading-one);
  border: none;
  border-radius: 12px;
  font-size: 3rem;
  font-weight: 400;
...
.galleryCardBottomTextHomepage:hover,
.galleryCardBottomTextHomepage:focus-visible {
...
.galleryCardBottomTextHomePage.expanded {
  background-color: transparent;
  color: red;
  border-color: var(--primary-color);
}

    ...
    <div class="form-container">
        ...
        <form ref="formRef" @submit.prevent="submitForm" enctype="multipart/form-data">
            ...
            <div class="radio-group">
                <label><input type="radio" name="assetType" value="3D Model" v-model="formData.assetType" required /> 3D Model</label>
                <label><input type="radio" name="assetType" value="Audio" v-model="formData.assetType" /> Audio</label>
                <label><input type="radio" name="assetType" value="Motion Capture" v-model="formData.assetType" /> Motion Capture</label>
            ...
            <div class="radio-group">
                <label><input type="radio" name="license" value="CC BY 4.0 DEED" v-model="formData.license" required /> CC BY 4.0 DEED</label>
                <label><input type="radio" name="license" value="CC BY-NC 4.0 DEED" v-model="formData.license" /> CC BY-NC 4.0 DEED</label>
                <label><input type="radio" name="license" value="CC BY-NC-ND 4.0 DEED" v-model="formData.license" /> CC BY-NC-ND 4.0 DEED</label>
                <label><input type="radio" name="license" value="Upon Request" v-model="formData.license" /> Upon Request</label>
            </div>
